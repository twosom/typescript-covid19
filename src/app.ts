...
import { CountryInfo, CovidStatus, CovidSummaryResponse } from './covid';
...
function fetchCountryInfo(
    countryCode: string,
    status: CovidStatus
): Promise<AxiosResponse<Array<CountryInfo>>> {
...
function setDeathsList(data: Array<CountryInfo>) {
    const sorted = data.sort(
        (a: CountryInfo, b: CountryInfo) => getUnixTimestamp(b.Date) - getUnixTimestamp(a.Date)
    );
